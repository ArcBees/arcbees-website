 ...
 * get our {@link UiHandlers} and to set them if needed.
 * 
...
public interface UiHandlersStrategy<H extends UiHandlers> {
   ...
   * 
   * @param uiHandlers {@link UiHandlers} implementation to set.
   */
  void setUiHandlers(H uiHandlers);

  /**
   * This let you retrieve you {@link UiHandlers} implementation.
   * 
   * @return {@link UiHandlers} implementation
   */
  H getUiHandlers();
}
