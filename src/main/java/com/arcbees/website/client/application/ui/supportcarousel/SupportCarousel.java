...
package com.arcbees.website.client.application.ui.supportcarousel;
...
public class SupportCarousel implements IsWidget {
    interface Binder extends UiBinder<HTMLPanel, SupportCarousel> {
    }
